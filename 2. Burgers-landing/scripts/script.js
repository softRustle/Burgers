...
let burger = document.getElementById("burger-id");
let name = document.getElementById("name-id");
let phone = document.getElementById("phone-id");

document.getElementById("order-action-id").onclick = function (){
    let hasError = false;
...
document.getElementById("change-currency-id").onclick = function (e) {
